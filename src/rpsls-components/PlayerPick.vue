<template>
  <div class="w-[314px] h-[314px] relative flex flex-col z-10">
    ...
    <div class="absolute z-20 flex flex-col justify-center items-center">
      <div class="mx-auto">
        <GameToken step="1" choice="scissors" @click="play('scissors')" />
      </div>
      <div class="flex justify-between w-[314px] -mt-6">
        <GameToken step="1" choice="spock" @click="play('spock')" />
        <GameToken step="1" choice="paper" @click="play('paper')" />
      </div>
      <div class="flex justify-between w-[214px] mt-6">
        <GameToken step="1" choice="lizard" @click="play('lizard')" />
